...
class WorkspaceGetWorkspaceByIdDefaultResponse(BaseModel):
    """
    WorkspaceGetWorkspaceByIdDefaultResponse
    """ # noqa: E501
    message: StrictStr
    code: StrictStr
    issues: Optional[List[WorkspaceGetWorkspaceByIdDefaultResponseIssuesInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "issues": [WorkspaceGetWorkspaceByIdDefaultResponseIssuesInner.from_dict(_item) for _item in obj.get("issues")] if obj.get("issues") is not None else None
        })
        return _obj
