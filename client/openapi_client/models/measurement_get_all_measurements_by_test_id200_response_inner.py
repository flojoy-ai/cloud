...
class MeasurementGetAllMeasurementsByTestId200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["isDeleted", "data", "deviceId", "id", "measurementType", "name", "storageProvider", "testId", "createdAt", "device"]
