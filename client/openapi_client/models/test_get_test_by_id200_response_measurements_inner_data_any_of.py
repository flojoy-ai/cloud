...
class TestGetTestById200ResponseMeasurementsInnerDataAnyOf(BaseModel):
    """
    TestGetTestById200ResponseMeasurementsInnerDataAnyOf
    """ # noqa: E501
    type: StrictStr
    passed: StrictBool
    __properties: ClassVar[List[str]] = ["type", "passed"]
