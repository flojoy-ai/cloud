...
# Create a device
device = client.create_device("DEVICE_NAME", "${params.workspaceId}")

# Get an existing device
device = client.get_device_by_id("DEVICE_ID")

# Get all devices from this workspace
devices = client.get_all_devices("${params.workspaceId}")

# Get all devices from this project
devices = client.get_all_devices("${params.workspaceId}", "${params.projectId}")
